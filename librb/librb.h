 ...
 * ring-buffer state
 */
#define rb_set_cantput(a)    bit_set(&(a)->flags,RB_CANTPUT)
#define rb_clr_cantput(a)  bit_clear(&(a)->flags,RB_CANTPUT)
#define rb_is_cantput(a)    bit_test(&(a)->flags,RB_CANTPUT)
#define rb_set_cantecho(a)   bit_set(&(a)->flags,RB_CANTECHO)
#define rb_clr_cantecho(a) bit_clear(&(a)->flags,RB_CANTECHO)
#define rb_is_cantecho(a)   bit_test(&(a)->flags,RB_CANTECHO)
#define rb_set_cantget(a)    bit_set(&(a)->flags,RB_CANTGET)
#define rb_clr_cantget(a)  bit_clear(&(a)->flags,RB_CANTGET)
#define rb_is_cantget(a)    bit_test(&(a)->flags,RB_CANTGET)
...
#define rb_clear(a) do {                                                       \
    bitmask_set_clear(&(a)->flags,RB_CANTECHO_MSK|RB_CANTGET_MSK,RB_CANTPUT_MSK); \
